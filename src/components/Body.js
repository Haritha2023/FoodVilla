...
import useAllRestaurant from "../utils/useAllRestaurant"; // imported custom hook useResData which gives All Restaurant and  Filtered Restaurant data from swigy api
...
const Body = () => {
  ...
  const [allRestaurants, FilterRes] = useAllRestaurant(swiggy_api_URL);
